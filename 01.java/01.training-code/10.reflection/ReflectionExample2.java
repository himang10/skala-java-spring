...
public class ReflectionExample2 {
    public static void main(String[] args) throws Exception {
        ...
        //5.1. private 메소드 호출 with String parameter
        Method sayHelloWithParamMethod = personClass.getDeclaredMethod("sayHello", String.class);
        sayHelloWithParamMethod.setAccessible(true);
        sayHelloWithParamMethod.invoke(person1, "Hi");
