package com.skala.example.controller;
...
import com.skala.example.domain.User;
...
public class UserController {
    private List<User> users = new ArrayList<>(List.of(
        new User(1, "alice", "alice@example.com", List.of("reading", "traveling")),
        new User(2, "bob", "bob@example.com", List.of("gaming", "cooking")),
        new User(3, "charlie", "charlie@example.com", List.of("hiking", "swimming"))
